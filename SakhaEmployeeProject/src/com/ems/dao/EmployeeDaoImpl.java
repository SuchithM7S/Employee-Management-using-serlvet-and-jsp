...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public Connection getConnection() throws SQLException {
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost/employeeSakha","root","root");
		return con;
	}
...
//		ps.setString(3,strDate);
	...
	public List<Employee> getAllEmployees() throws Exception{
		...
		while(rs.next()) {
			java.sql.Date rowdate=rs.getDate(3);
			Employee emp=new Employee(rs.getString(1),rs.getString(2),LocalDate.of(rowdate.getYear()+1900,rowdate.getMonth(),rowdate.getDate()),rs.getFloat(4));
			emplist.add(emp);
		}
		return emplist;
	}
